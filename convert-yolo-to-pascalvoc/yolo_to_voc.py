...
## coco classes
YOLO_CLASSES = ('Central Incisor', 'Lateral Incisor','Canine','1st Premolar','2nd Premolar','1st Molar','2nd Molar','3rd Molar')
...
def xml_transform(root, classes):  
    ...
    for i in range(len(ids)):
        img_id = ids[i] 
        for ex in ["%s.jpg", "%s.jpeg", "%s.png", "%s.JPG", "%s.JPEG", "%s.PNG"]:
            imgpath = join(root, 'images', ex% img_id)
